...
app.config.update(
    ...
    MAIL_PORT='465',
    MAIL_USE_SSL=True,
    MAIL_USERNAME='priyanshudixit404@gmail.com',
    MAIL_PASSWORD='anpzhzkmunkznsig'
)
mail = Mail(app)
...
# app.config['SQLALCHEMY_DATABASE_URI']='mysql://root:Priyanshu@29#@localhost/covid_dbms'
